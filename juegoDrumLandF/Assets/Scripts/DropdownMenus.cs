...
// Modificar las opciones de los dropdown menus ya que contienen muchas opciones
public class DropdownMenus : MonoBehaviour
{

    public TMP_Dropdown countryDropdown;
    string[] countries = { "Afghanistan", "Aland Islands", "Albania", "Algeria", "American Samoa", "Andorra",
